...
- `BUY`: 반론과 중요한 불확실성을 고려한 뒤에도, 현재 가격이 그 불확실성을 충분히 보상하고 사업과 가격의 위험/보상이 매력적인 경우.
- `WATCH`: 잠재적으로 매력적이지만, 현재 가격이 남은 불확실성을 충분히 보상하는지 아직 underwrite하기 어렵거나 기대 차이가 행동할 만큼 크지 않은 경우.
